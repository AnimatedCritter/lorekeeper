...
class SpeciesController extends Controller {
    ...
    */
    ...
    public function postCreateEditSpecies(Request $request, SpeciesService $service, $id = null) {
        ...
        $data = $request->only([
            'name', 'description', 'image', 'remove_image', 'masterlist_sub_id', 'is_visible', 'is_free_myo_usable',
        ]);
    ...
    public function postCreateEditSubtype(Request $request, SpeciesService $service, $id = null) {
        ...
        $data = $request->only([
            'species_id', 'name', 'description', 'image', 'remove_image', 'is_visible', 'is_free_myo_usable',
        ]);
