...
<div class="card p-3 mb-2">
    ...
    <p>These terms will be visible to all users. Please note that these terms are not binding, unless you have recieved an electronic signature from the user in question. You are responsible to obtain and record all desired e-signatures.</p>
    {!! Form::open(['url' => 'account/terms']) !!}

        @if(Settings::get('external_terms'))
            <div class="form-group">
                {!! Form::label('text', 'URL to External Terms') !!} {!! add_help('You may include a link to an off-site T.o.S. page. This *must* be a single *and* complete URL to work.') !!}
                {!! Form::text('url', Auth::user()->terms->url, ['class' => 'form-control']) !!}
            </div>
        @endif
        <div class="form-group">
