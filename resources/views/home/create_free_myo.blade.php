...
@section('scripts')
    ...
    <script>
        $("#species").change(function() {
            ...
            $.ajax({
                type: "GET",
                url: "{{ url('characters/check-subtype') }}?species=" + species + "&myo=" + myo,
                dataType: "text"
            }).done(function(res) {
                $("#subtypes").html(res);
            ...
            $.ajax({
                type: "GET",
                url: "{{ url('characters/get-myo-preview') }}?species=" + species,
                dataType: "text"
            }).done(function(res) {
                document.getElementById('speciesPreviewImg').src = (res);
                console.log(res);
            }).fail(function(jqXHR, textStatus, errorThrown) {
                alert("AJAX call failed: " + textStatus + ", " + errorThrown);
            });
        ...
        $("#subtypes").change(function() {
            ...
            $.ajax({
                type: "GET",
                url: "{{ url('characters/get-myo-preview') }}?subtype=" + subtype,
                dataType: "text"
            }).done(function(res) {
                document.getElementById('speciesPreviewImg').src = (res);
                console.log(res);
